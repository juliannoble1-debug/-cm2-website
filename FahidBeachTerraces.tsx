...
const GALLERY_IMAGE = "https://d2xsxph8kpxj0f.cloudfront.net/310419663031253658/68KcWAaMsChVyE7UijVTrv/fahid-beach-terraces-hero_8c338825.png";

export default function FahidBeachTerraces() {
  useSEO({
    title: "Fahid Beach Terraces Abu Dhabi — Aldar Beachfront Tower | CM2",
    description: "Fahid Beach Terraces — premium beachfront tower residences on Fahid Island, Abu Dhabi. 1 to 4 bedrooms, duplexes and penthouses by Aldar Properties. Handover circa 2029. Enquire with CM2.",
    ogImage: HERO_IMAGE,
    canonical: "https://www.thecm2.com/projects/fahid-beach-terraces",
  });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    submitLead.mutate({ name: form.name, email: form.email, whatsapp: form.whatsapp, notes: "Fahid Beach Terraces", market: "Abu Dhabi", source: "fahid-beach-terraces-landing" });
  };
    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <section className="relative pt-14 min-h-[80vh] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 pb-12 lg:pb-20">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl text-white mb-3 leading-tight" style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 500 }}>Fahid Beach Terraces</h1>
            <p className="text-white/80 text-lg mb-6" style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic" }}>Premium beachfront towers — duplexes and penthouses on 11km of coastline.</p>
            <div className="flex flex-col sm:flex-row gap-3">
              <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-white text-[#111111] text-sm font-medium px-6 py-3 hover:bg-[#F5F3F0] transition-colors">
                ...
                Download Floorplans on WhatsApp
              </a>
              <a href="#enquire" className="inline-flex items-center justify-center border border-white/60 text-white text-sm font-medium px-6 py-3 hover:bg-white/10 transition-colors">Enquire Now</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <h2 className="text-3xl text-[#111111] mb-4 leading-snug" style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 500 }}>Premium beachfront tower product for high-net-worth buyers.</h2>
              <p className="text-[#6B6B6B] text-[0.9375rem] leading-relaxed mb-4">Fahid Beach Terraces represents the premium tier within the Fahid Island masterplan — beachfront tower residences offering 1 to 4 bedroom apartments alongside duplexes and penthouses. Delivery is targeted for circa 2029.</p>
              <p className="text-[#6B6B6B] text-[0.9375rem] leading-relaxed">Positioned for buyers seeking a distinctive, scarce beachfront product in Abu Dhabi with long-term capital growth credentials.</p>
            </div>
            <div className="space-y-3">
              {[
                { label: "Location", value: "Fahid Island, Abu Dhabi" },
                { label: "Unit Types", value: "1–4 bedroom apartments, duplexes, penthouses" },
                { label: "Positioning", value: "Premium beachfront tower" },
                { label: "Delivery", value: "Circa 2029" },
                { label: "Developer", value: "Aldar Properties" },
                { label: "Masterplan", value: "Fahid Island — 11km coastline" },
              ].map((item) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <h2 className="text-2xl sm:text-3xl text-[#111111] mb-8 leading-snug" style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 500 }}>Five reasons to consider Fahid Beach Terraces.</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: "Premium Beachfront Product", body: "Duplexes and penthouses with direct beach access — a rare product type in Abu Dhabi's residential market." },
              { title: "Supply Scarcity", body: "Comparable beachfront tower product in Abu Dhabi is limited. Fahid Beach Terraces occupies a distinctive position." },
              { title: "11km Coastline", body: "Set within Fahid Island's 11km of waterfront — one of the largest new coastal masterplans in the UAE." },
              { title: "Strategic Location", body: "Between Yas Island and Saadiyat Island — Abu Dhabi's two most established and internationally recognised investment addresses." },
              { title: "Aldar Developer Credibility", body: "Aldar Properties is Abu Dhabi's largest listed developer. Fahid Island is a flagship commitment to the waterfront residential market." },
            ].map((item) => (
      ...
      <section className="py-12 bg-[#F9F8F6]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <img src={HERO_IMAGE} alt="Fahid Beach Terraces beachfront aerial" className="w-full h-64 object-cover" loading="lazy" />
            <img src={GALLERY_IMAGE} alt="Fahid Beach Terraces exterior view" className="w-full h-64 object-cover" loading="lazy" />
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl text-[#111111] mb-4 leading-snug" style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 500 }}>Request floor plans and full project details.</h2>
              <p className="text-[#6B6B6B] text-[0.9375rem] leading-relaxed mb-6">A CM2 advisor will respond within 24 hours with floor plans, current pricing, and payment plan options for Fahid Beach Terraces.</p>
              <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-[#111111] text-white text-sm font-medium px-6 py-3 hover:bg-[#333] transition-colors">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                Download Floorplans on WhatsApp
              </a>
            </div>
            <div>
