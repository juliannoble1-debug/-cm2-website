...
const HERO_IMAGE = "https://d2xsxph8kpxj0f.cloudfront.net/310419663031253658/68KcWAaMsChVyE7UijVTrv/beach-house-fahid-hero_4b7f2856.jpeg";
const GALLERY_IMAGE = "https://d2xsxph8kpxj0f.cloudfront.net/310419663031253658/68KcWAaMsChVyE7UijVTrv/beach-house-fahid-cgi04_941a309e.jpeg";

export default function FahidBeachResidences() {
  useSEO({
    title: "Fahid Beach Residences Abu Dhabi — Aldar Waterfront Apartments | CM2",
    ...
    ogImage: HERO_IMAGE,
    canonical: "https://www.thecm2.com/projects/fahid-beach-residences",
  });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    submitLead.mutate({ name: form.name, email: form.email, whatsapp: form.whatsapp, notes: "Fahid Beach Residences", market: "Abu Dhabi", source: "fahid-beach-residences-landing" });
  };
    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <section className="relative pt-14 min-h-[80vh] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 pb-12 lg:pb-20">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl text-white mb-3 leading-tight" style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 500 }}>Fahid Beach Residences</h1>
            <p className="text-white/80 text-lg mb-6" style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic" }}>Waterfront residences on Aldar's flagship island masterplan.</p>
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a href="#enquire" className="inline-flex items-center justify-center border border-white/60 text-white text-sm font-medium px-6 py-3 hover:bg-white/10 transition-colors">Book Viewing</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <h2 className="text-3xl text-[#111111] mb-4 leading-snug" style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 500 }}>A diverse waterfront offering for investors and families.</h2>
              <p className="text-[#6B6B6B] text-[0.9375rem] leading-relaxed mb-4">Fahid Beach Residences offers 1 to 4 bedroom apartments alongside townhouses and penthouses on Fahid Island — Aldar's flagship waterfront masterplan in Abu Dhabi. The development sits within an 11km coastline between Yas Island and Saadiyat Island, two of Abu Dhabi's most established investment addresses.</p>
              <p className="text-[#6B6B6B] text-[0.9375rem] leading-relaxed">Suited to both investors seeking capital growth and families looking for premium waterfront living. Estimated handover 2029.</p>
            </div>
            <div className="space-y-3">
              {[
                { label: "Location", value: "Fahid Island, Abu Dhabi" },
                { label: "Unit Types", value: "1–4 bedroom apartments, townhouses, penthouses" },
                { label: "Handover", value: "Estimated 2029" },
                { label: "Developer", value: "Aldar Properties" },
                { label: "Masterplan", value: "Fahid Island — 11km coastline, 6,000+ residences" },
              ].map((item) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <h2 className="text-2xl sm:text-3xl text-[#111111] mb-8 leading-snug" style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 500 }}>Five reasons to consider Fahid Beach Residences.</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: "Flagship Aldar Masterplan", body: "Fahid Island is Aldar's most ambitious waterfront project — 11km of coastline with resort-quality infrastructure." },
              { title: "Diverse Unit Mix", body: "Apartments, townhouses, and penthouses accommodate a wide range of investor profiles and budgets." },
              { title: "Prime Location", body: "Positioned between Yas Island and Saadiyat Island — two of Abu Dhabi's strongest and most liquid investment corridors." },
              { title: "Wellness-Led Design", body: "The masterplan prioritises outdoor living, beach access, and wellness amenities throughout." },
              { title: "Strong Sales Momentum", body: "Early phases have demonstrated genuine buyer demand, reflecting confidence in the project and location." },
            ].map((item) => (
      ...
      <section className="py-12 bg-[#F9F8F6]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <img src={HERO_IMAGE} alt="Fahid Beach Residences exterior" className="w-full h-64 object-cover" loading="lazy" />
            <img src={GALLERY_IMAGE} alt="Fahid Beach Residences waterfront view" className="w-full h-64 object-cover" loading="lazy" />
          </div>
      ...
      <section id="enquire" className="py-20 bg-[#F9F8F6]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <p className="text-xs tracking-[0.15em] uppercase text-[#9B8E7E] mb-4">Request Details</p>
              <h2 className="text-3xl sm:text-4xl text-[#111111] mb-4 leading-snug" style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 500 }}>Request the Fahid Beach Residences brochure.</h2>
              <p className="text-[#6B6B6B] text-[0.9375rem] leading-relaxed mb-6">A CM2 advisor will respond within 24 hours with the full brochure, floor plans, and current pricing.</p>
